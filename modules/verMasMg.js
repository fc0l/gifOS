...
import { mis_gifos_container, navbar_mis_gifos} from './routes.js';

const ver_mas_misgifos = document.getElementById("mis-gifos-vermas");


ver_mas_misgifos.addEventListener("click", verMasFavoritos);
navbar_mis_gifos.addEventListener("click", modify_limit);
...
function modify_limit () {
    ...
    limite = 25;
    offset = 13;
    ver_mas_misgifos.style.display = "block"
}
...
async function verMasFavoritos (e)
{
    ...
    if(json_size > limit_i)
    {
        ...
        {
            ver_mas_misgifos.style.display = "none";
        }
    }    
    else
    {
